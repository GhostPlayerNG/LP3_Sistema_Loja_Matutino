...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("cp_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa)  {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/contapagar.jsp?status=Consulta efetuada com sucesso&cp_codigo="+  
