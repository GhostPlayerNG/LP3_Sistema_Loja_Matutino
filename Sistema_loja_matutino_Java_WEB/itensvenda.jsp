...
<form name="cadastro" method="get">       
    <table width="" border="">  
        <tr>  
            <td width="" height="" bgcolor="red"><p align="l5eft" class="style"> Cadastro itens venda</p>  
            </td>  
        </tr>  
        <tr>  
            <td height="" bgcolor="red"><p> <strong>Codigo: </strong>  
                ...
                <input name="itv_qtdeField" type="text" id="itv_qtdeField" size="" value="<%=(itv_qtde==null)?"":itv_qtde%>"> </p> 
                <p><strong>Valor Unitario: </strong>  
                <input name="itv_valorunField" type="text" id="itv_valorunField" size="" value="<%=(itv_valorun==null)?"":itv_valorun%>"> </p>
