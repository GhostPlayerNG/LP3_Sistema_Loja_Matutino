...
var op5 = new Array(2);
op5[0] = new CriaMenu("Produtos",null,"produtos.jsp");
...
op3[1] = new CriaMenu("Itens Compra",null,"itenscompra.jsp");

var op2 = new Array(2);
op2[0] = new CriaMenu("Funcionarios",null,"funcionario.jsp");
op2[1] = new CriaMenu("Fornecedor",null,"fornecedor.jsp");

var op1 = new Array(3);
op1[0] = new CriaMenu("Nota Fiscal",null,"notafiscal.jsp");
op1[1] = new CriaMenu("Conta a Receber",null,"contareceber.jsp");
op1[2] = new CriaMenu("Conta a Pagar",null,"contapagar.jsp");
