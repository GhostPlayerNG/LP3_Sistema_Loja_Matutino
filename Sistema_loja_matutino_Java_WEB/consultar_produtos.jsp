...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("pro_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa)  {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/produtos.jsp?status=Consulta efetuada com sucesso&pro_codigo="+  
        ...
        response.sendRedirect("http://localhost:8084/sistema_loja_matutino/produtos.jsp?status=Registro não encontrado");  
	}            
	%>  
</form>  
</body>  
