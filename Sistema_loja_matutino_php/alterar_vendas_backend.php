...
$alterar= mysql_query("UPDATE tb_vendas
                      SET ven_datavenda='$ven_datavenda1' , fun_codigo='$fun_codigo1',
					 tpg_codigo='$tpg_codigo1',  nf_codigo='$nf_codigo1',
					 ven_valortotal='$ven_valortotal1',ven_observacoes='$ven_observacoes1'
