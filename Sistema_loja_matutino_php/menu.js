...
op4[1] = new CriaMenu("Conta_Pagar",null,"consulta_contapagar.php");
op4[2] = new CriaMenu("Conta_Receber",null,"consulta_contareceber.php");
op4[3] = new CriaMenu("Fornecedor",null,"consulta_fornecedor.php");
op4[4] = new CriaMenu("Funcionario",null,"consulta_funcionario.php");
op4[5] = new CriaMenu("Itens_Compra",null,"consulta_itenscompra.php");
op4[6] = new CriaMenu("Itens_Venda",null,"consulta_itensvenda.php");
op4[7] = new CriaMenu("Nota_Fiscal",null,"consulta_notafiscal.php");
op4[8] = new CriaMenu("Produtos",null,"consulta_produtos.php");
op4[9] = new CriaMenu("Tipo_Pagamento",null,"consulta_tipopagto.php");
op4[10] = new CriaMenu("Tipo_Produto",null,"consulta_tipoproduto.php");
...
op3[1] = new CriaMenu("Conta_Pagar",null,"excluir_contapagar_frontend.php");
op3[2] = new CriaMenu("Conta_Receber",null,"excluir_contareceber_frontend.php");
...
op3[9] = new CriaMenu("Tipo_Pagamento",null,"excluir_tipopagto_frontend.php");
op3[10] = new CriaMenu("Tipo_Produto",null,"excluir_tipoproduto_frontend.php");
...
op2[1] = new CriaMenu("Conta_Pagar",null,"alterar_contapagar_frontend.php");
op2[2] = new CriaMenu("Conta_Receber",null,"alterar_contareceber_frontend.php");
...
op2[5] = new CriaMenu("Itens_Compra",null,"alterar_itenscompra_frontend.php");
op2[6] = new CriaMenu("Itens_Venda",null,"alterar_itensvenda_frontend.php");
op2[7] = new CriaMenu("Nota_Fiscal",null,"alterar_notafiscal_frontend.php");
op2[8] = new CriaMenu("Produtos",null,"alterar_produto_frontend.php");
op2[9] = new CriaMenu("Tipo_Pagamento",null,"alterar_tipopagto_frontend.php");
op2[10] = new CriaMenu("Tipo_Produto",null,"alterar_tipoproduto_frontend.php");
op2[11] = new CriaMenu("Vendas",null,"alterar_vendas_frontend.php");

var op1 = new Array(12);
op1[0] = new CriaMenu("Compras",null,"incluir_contareceber_frontend.php");
op1[1] = new CriaMenu("Conta_Pagar",null,"incluir_contapagar_frontend.php");
op1[2] = new CriaMenu("Conta_Receber",null,"incluir_contareceber_frontend.php");
...
op1[5] = new CriaMenu("Itens_Compra",null,"incluir_itenscompra_frontend.php");
op1[6] = new CriaMenu("Itens_Venda",null,"incluir_itensvenda_frontend.php");
op1[7] = new CriaMenu("Nota_Fiscal",null,"incluir_notafiscal_frontend.php");
op1[8] = new CriaMenu("Produtos",null,"incluir_produtos_frontend.php");
op1[9] = new CriaMenu("Tipo_Pagamento",null,"incluir_tipopagto_frontend.php");
op1[10] = new CriaMenu("Tipo_Produto",null,"incluir_tipoproduto_frontend.php");
