...
$inserir = mysql_query("INSERT INTO tb_itensvenda (itv_codigo,ven_codigo,pro_codigo,tpp_codigo,nf_codigo,tpg_codigo,fun_codigo,itv_embalagem,itv_qtde,itv_valorun,itv_desc,itv_valortotal)
	VALUES('$itv_codigo1','$ven_codigo1','$pro_codigo1','$tpp_codigo1','$nf_codigo1','$tpg_codigo1','$fun_codigo1','$itv_embalagem1','$itv_qtde1','$itv_valorun1','$itv_desc1','$itv_valortotal1')") 
		or die (mysql_error());
mysql_close ($db);
