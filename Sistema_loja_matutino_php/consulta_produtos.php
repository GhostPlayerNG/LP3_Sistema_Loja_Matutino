...
<tr>
	...
	<td class='consult'><h1>Descrição</h1></td>
	<td class='consult'><h1>Codigo Tipo Produto</h1></td>
	<td class='consult'><h1>Preço Custo</h1></td>
	<td class='consult'><h1>Preço Venda</h1></td>
	<td class='consult'><h1>Estoque</h1></td>
	<td class='consult'><h1>Embalagem</h1></td>
	<td class='consult'><h1>IPI</h1></td>	
</tr>";
