...
<!-- Inicio Alterar -->
<center>
<form method="post" action="alterar_itensvenda_backend.php">
Alterar Itens Venda <br>
<table class="null">
<tr>
	<td>Codigo:</td> 
	<td><select size="1" name="itv_codigo">
	<?php
...
<input type="submit" name="Submit" value="Alterar" class="btn"></td>
</form>
</center>