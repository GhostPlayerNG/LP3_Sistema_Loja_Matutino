...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("cr_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa)  {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/contareceber.jsp?status=Consulta efetuada com sucesso&cr_codigo="+  
