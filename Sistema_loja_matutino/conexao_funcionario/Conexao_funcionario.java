package Sistema_loja_matutino.conexao_funcionario;
...
public class Conexao_funcionario {
    ...
    public Conexao_funcionario() {  
         try {  
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sistema_loja_matutino","root","vertrigo");  
    ...
    public void inserirDados(){
        try {  
            String query = "insert into tb_funcionario(fun_codigo,fun_nome,fun_endereco,fun_numero,fun_complemento,fun_bairro,fun_cidade,fun_uf,fun_cnpjcpf,fun_rgie,fun_sexo,fun_nascimento,fun_telefone,fun_celular,fun_email,fun_salario) "
                    + "values("+fun_codigo+",\""+fun_nome+"\",\""+fun_endereco+"\",\""+fun_numero+"\",\""+fun_complemento+"\",\""+fun_bairro+"\",\""+fun_cidade+" \",\" "+fun_uf+"\",\""+fun_cnpjcpf+"\",\""+fun_rgie+"\",\""+fun_sexo+"\",\""+fun_nascimento+"\",\""+fun_telefone+"\",\""+fun_celular+"\",\""+fun_email+"\",\""+fun_salario+"\")";  
