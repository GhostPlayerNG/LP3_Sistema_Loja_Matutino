package Sistema_loja_matutino.conexao_contapagar;
import java.sql.*;
/**
 * @author gabri
 */
    ...
    public void inserirDados(){
        try {  
            /*String query = "insert into tb_contapagar(cp_codigo,cp_valorconta,cp_datavencimento,cp_datapagamento, nf_codigo,cp_observacoes) "
                    + "values("+cp_codigo+",\" "+cp_valorconta+" \",\" "+cp_datavencimento+" \",\" "+cp_datapagamento+" \",\" "+nf_codigo+" \",\" "+cp_observacoes+" \")";  
            */
            String query = "insert into tb_contapagar(cp_codigo,cp_valorconta,"
                    ...
                    + "values("+cp_codigo+",\""+cp_valorconta+"\",\""+cp_datavencimento+"\","
