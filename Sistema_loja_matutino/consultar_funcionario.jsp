...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("fun_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa)  {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/funcionario.jsp?status=Consulta efetuada com sucesso&fun_codigo="+  
        ...
        response.sendRedirect("http://localhost:8084/sistema_loja_matutino/funcionario.jsp?status=Registro não encontrado");  
	}            
	%>  
</form>  
</body>  
