package Sistema_loja_matutino.conexao_itenscompra;
...
public class Conexao_itenscompra {
    ...
    public void inserirDados(){
        try {  
            String query = "insert into tb_itenscompra(itc_codigo,com_codigo,pro_codigo,tpp_codigo,nf_codigo,for_codigo,tpg_codigo,"
                    + "itc_embalagem,itc_qtde,itc_valorun,itc_desc,itc_valortotal) "
                    + "values("+itc_codigo+","+com_codigo+","+pro_codigo+","+tpp_codigo+","+nf_codigo+","+nf_codigo+","+for_codigo+","
                    + " \""+itc_embalagem+"\",\""+itc_qtde+"\",\""+itc_valorun+"\",\""+itc_desc+"\",\""+itc_valortotal+"\")";  
