...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("com_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa) {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/compras.jsp?status=Consulta efetuada com sucesso&com_codigo="+  
        ...
        response.sendRedirect("http://localhost:8084/sistema_loja_matutino/compras.jsp?status=Registro não encontrado");  
	}            
	%>  
</form>  
</body>  
