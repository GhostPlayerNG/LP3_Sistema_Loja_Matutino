...
<form method="get">  
	<%  
	con.setNome(Integer.parseInt(request.getParameter("itv_codigoField")));  
	boolean testa = con.consultarDados();           
	if (testa)  {           
		ResultSet temp = con.getResultado();  
		response.sendRedirect("http://localhost:8084/sistema_loja_matutino/itensvenda.jsp?status=Consulta efetuada com sucesso&itv_codigo="+  
        ...
        response.sendRedirect("http://localhost:8084/sistema_loja_matutino/itensvenda.jsp?status=Registro não encontrado");  
	}            
	%>  
</form>  
</body>  
