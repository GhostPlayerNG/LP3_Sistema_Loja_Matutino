package Sistema_loja_matutino.conexao_itensvenda;
...
public class Conexao_itensvenda {
    ...
    public void inserirDados(){
        try {  
            String query = "insert into tb_itensvenda(itv_codigo,ven_codigo,pro_codigo,tpp_codigo,nf_codigo,tpg_codigo,fun_codigo,itv_embalagem,itv_qtde,itv_valorun,itv_desc,itv_valortotal) "
